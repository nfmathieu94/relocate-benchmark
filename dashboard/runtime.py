...
from dashboard.data.loaders import ReportBundle, load_reports
...
def _cached_load(report_dir: str) -> ReportBundle:
    return load_reports(Path(report_dir))
...
def load_bundle() -> ReportBundle:
    ...
    try:
        bundle = _cached_load(str(report_dir))
